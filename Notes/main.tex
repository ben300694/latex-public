...
\begin{proof}
	...
	\marginnote{Dehn's Lemma \citep[4.A.1]{rolfsen2003knots}: 
		Suppose $M^{3}$ is a $3$-manifold and $f \colon \disk{2} \rightarrow M^{3}$
		is a piecewise-linear map of a disk with no singularities on the boundary
		(i.e. $x \in \partial \disk{2}, x \ne y \in \disk{2} \Rightarrow f(x) \ne f(y)$). \\
...
\begin{itemize}
	\item \citep{ohtsuki2002problems}
	\item \citep{bar1995vassiliev}
\end{itemize}
